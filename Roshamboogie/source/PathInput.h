...
#ifndef __PATH_INPUT_H__
#define __PATH_INPUT_H__
#include <cugl/cugl.h>
...
private:
    ...
    /** The  touch location for the current gesture */
    cugl::Vec2 _dtouch;
...
#pragma mark Constructors
     ...
     */
    PathInput(); // Don't initialize.  Allow stack based
...
#pragma mark Input Results
    ...
    const cugl::Vec2& getPath() const {return _dtouch;}
